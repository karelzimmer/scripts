...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  xmlns:math="http://exslt.org/math" xmlns:date="http://exslt.org/dates-and-times" xmlns:re="http://exslt.org/regular-expressions"
  xmlns:py="urn:ecr:python-functions"
  extension-element-prefixes="math date re py"
>
<xsl:output method="xml" indent="yes" encoding="UTF-8" />
<!--  Voor xslt2.0 fn's moet je bij xsl-stylesheet version="2.0" zetten. Python lxml werkt met 1.0 + exslt
       extensies. Vlg beide goed om ns te onderdrukken.
